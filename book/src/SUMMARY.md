...
- [safe.guard](modules/guard.md)
- [safe.log](modules/log.md)
- [safe.validate](modules/validate.md)
- [safe.shell](modules/shell.md)
- [safe.perf](modules/perf.md)
- [safe.test_helpers](modules/test_helpers.md)

---

# Quality

- [CB-600 Compliance](compliance.md)
...
- [OOP Patterns](examples/oop_patterns.md)
- [Error Handling](examples/error_handling.md)
- [Weak Tables](examples/weak_tables.md)
- [Coroutine Patterns](examples/coroutine_patterns.md)
- [Global Protection](examples/global_protection.md)
- [String Building](examples/string_building.md)
- [Type Annotations](examples/type_annotations.md)
- [Require Safety](examples/require_safety.md)
- [Operator Overloading](examples/operator_overloading.md)
- [Table Operations](examples/table_operations.md)
- [Observer Pattern](examples/observer_pattern.md)
- [Proxy Tables](examples/proxy_tables.md)
- [Closure Patterns](examples/closure_patterns.md)
